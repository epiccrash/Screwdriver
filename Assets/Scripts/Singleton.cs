...
public abstract class Singleton<T> : MonoBehaviour where T : MonoBehaviour
{
    ...
    public static T Instance
    {
        ...
        set
        {
            SingletonAttribute attribute = Attribute.GetCustomAttribute(typeof(T), typeof(SingletonAttribute)) as SingletonAttribute;
            if (attribute == null)
    ...
    /// <returns></returns>
    private static bool TryGenerateInstance(SingletonAttribute.Type type, bool destroyOnLoad, string resourcesLoadPath, bool warn)
    {
        if (type == SingletonAttribute.Type.ExistsInScene)
        {
        ...
        else if (type == SingletonAttribute.Type.LoadedFromResources)
        {
            ...
            T pref = UnityEngine.Resources.Load<T>(resourcesLoadPath);
            if (pref == null)
            {
                if (warn)
        ...
        else if (type == SingletonAttribute.Type.CreateOnNewGameObject)
        {
